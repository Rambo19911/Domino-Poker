...
- `apps/web`: Next.js UI, main lobby, localized rules dialog, single-player game screen, settings dialog, CSS, and public game assets.
...
- `apps/web/components/AppShell.tsx`: main lobby, localized rules dialog, disabled multiplayer button, game screen switching, locale selection, and shared audio settings ownership.
